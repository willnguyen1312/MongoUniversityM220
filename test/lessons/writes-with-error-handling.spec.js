...
describe("Error Handling", async () => {
  /* Hello!
   * In this lesson we are going to talk about Error Handling. We will consider
   * a few scenarios and error categories and find ways ways to fix those errors.
   *
   * This way can ensure that your application is resilient to issues that can
   * occur in concurrent and distributed systems.
   *
   * Concurrent system will most likely have situations where duplicate keys
   * will occur, while distributed systems are prone to issues related to
